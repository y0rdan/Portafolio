Below is a **clean, portfolio-ready README project** for a **Kali Linux Attack Simulation Lab**. It is written to demonstrate offensive security skills in a controlled, ethical lab environment (no real-world targeting).

---

```markdown id="kali_attack_lab"
...
* kali-red-team-lab
* penetration-testing-simulation-lab
* offensive-security-kali-lab
